...
python tools/m1f.py -s ./wp-content/themes/my-theme \
...
python tools/m1f.py -s ./docs -o ./docs-bundle.md \
...
python tools/m1f.py -i important_files.txt \
...
- Parses combined files generated by `tools/m1f.py`.
