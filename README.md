...
- Smart caching (only processes what changed)
...
Let AI organize your bundles by topic. It's like having an AI assistant for your
AI assistant.

```bash
m1f-claude --setup  # Meta? Yes. Useful? Absolutely.
```
...
```bash
m1f --preset code-review --since HEAD~10
# Bundle only changes from last 10 commits
```
