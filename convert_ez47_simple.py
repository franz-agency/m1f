...
def main():
    # Base directories
    base_input_47 = Path('/home/fuf-user/ezdoc/ezpublishdoc.mugo.ca/eZ-Publish/Technical-manual/4.7')
    base_input_4x = Path('/home/fuf-user/ezdoc/ezpublishdoc.mugo.ca/eZ-Publish/Technical-manual/4.x')
