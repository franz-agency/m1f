...
class TestM1FEncoding(BaseM1FTest):
    ...
    def test_encoding_conversion_utf8(
        self,
        run_m1f,
        create_test_file,
        temp_dir
    ...
    @pytest.mark.unit
    @pytest.mark.encoding
    def test_encoding_errors_handling(
        self,
        run_m1f,
        temp_dir
    ):
    ...
    def test_mixed_encodings_in_directory(
        ...
        # Latin-1 files
        (source_dir / "legacy.txt").write_text("Legacy file: café, naïve", encoding="latin-1")
        
        # Create subdirectory with more files
        subdir = source_dir / "src"
        subdir.mkdir()
        (subdir / "main.py").write_text("#!/usr/bin/env python3\n# -*- coding: utf-8 -*-\nprint('Hello')", encoding="utf-8")
