...
class TestM1FAdvanced(BaseM1FTest):
    ...
    def test_create_archive_zip(
        self,
        run_m1f,
        create_m1f_test_structure,
        temp_dir
    ):
    ...
    def test_gitignore_pattern_support(
        ...
        exit_code, _ = run_m1f([
            "--source-directory", str(source_dir),
            "--output-file", str(output_file),
            "--exclude-paths-file", str(gitignore_file),
            "--force",
        ])
    ...
    def test_no_default_excludes(
        ...
        exit_code, _ = run_m1f([
            "--source-directory", str(source_dir),
            "--output-file", str(output_default),
            "--force",
        ])
        ...
        exit_code, _ = run_m1f([
            "--source-directory", str(source_dir),
            "--output-file", str(output_no_default),
            "--no-default-excludes",
            "--force",
        ])
    ...
    def test_large_file_handling(
        ...
        exit_code, _ = run_m1f([
            "--source-directory", str(large_file.parent),
            "--output-file", str(output_file),
            "--force",
        ])
    ...
    def test_include_binary_files(
        ...
        exit_code, _ = run_m1f([
            "--source-directory", str(source_dir),
            "--output-file", str(output_no_binary),
            "--force",
        ])
        ...
        exit_code, _ = run_m1f([
            "--source-directory", str(source_dir),
            "--output-file", str(output_with_binary),
