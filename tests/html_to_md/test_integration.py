...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if not self.prepare_docs_script.exists():
            self.skipTest(f"prepare_docs.py script not found: {self.prepare_docs_script}")
    ...
    def test_direct_conversion(self):
        ...
        cmd = [
            ...
            "--source-dir", str(self.html_dir),
            "--destination-dir", str(self.md_dir),
            "--add-frontmatter",
            "--convert-code-blocks",
            "--force"
        ]
    ...
    def test_html_structure_preservation(self):
        ...
        cmd = [
            ...
            "--source-dir", str(self.html_dir),
            "--destination-dir", str(self.md_dir),
            "--outermost-selector", "main.content",  # Only convert main content
            "--ignore-selectors", "nav", "footer", ".advertisement",
            "--add-frontmatter",
            "--force"
        ]
    ...
    def test_code_block_language_detection(self):
        ...
        self.assertIn("print(\"Hello, world!\")", content[python_index:python_index+200])
