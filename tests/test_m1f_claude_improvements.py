...
class TestM1FClaudeImprovements(unittest.TestCase):
    ...
    def test_message_type_handling(self):
        ...
        test_events = [
            ...
            {"type": "system", "subtype": "permission_prompt", "tool_name": "Read", "parameters": {"file": "test.py"}},
            ...
            {"type": "result", "subtype": "complete", "session_id": "test-123", "total_cost_usd": 0.01, "num_turns": 1, "duration": 2.5},
