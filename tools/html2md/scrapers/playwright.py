...
class PlaywrightScraper(WebScraperBase):
    ...
    def __init__(self, config: ScraperConfig):
        ...
        self._viewport = self._browser_config.get("viewport", {"width": 1920, "height": 1080})
    ...
    async def scrape_url(self, url: str) -> ScrapedPage:
        ...
        try:
            ...
            if self._browser_config.get("screenshot"):
                screenshot_path = self._browser_config.get("screenshot_path", "screenshot.png")
