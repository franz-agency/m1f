...
LOG_LEVELS = {
    "DEBUG": LogLevel("DEBUG", logging.DEBUG, Fore.BLUE if COLORAMA_AVAILABLE else None),
    "INFO": LogLevel("INFO", logging.INFO, Fore.GREEN if COLORAMA_AVAILABLE else None),
    "WARNING": LogLevel("WARNING", logging.WARNING, Fore.YELLOW if COLORAMA_AVAILABLE else None),
    "ERROR": LogLevel("ERROR", logging.ERROR, Fore.RED if COLORAMA_AVAILABLE else None),
    "CRITICAL": LogLevel("CRITICAL", logging.CRITICAL, Fore.RED if COLORAMA_AVAILABLE else None),
}
