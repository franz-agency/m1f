        ...
        for name, template_data in templates_data.items():
            ...
            if 'analysis' in template_data:
                ...
                template_analysis = AnalysisConfig(
                    relevance_threshold=ta.get('relevance_threshold', analysis_config.relevance_threshold),
                    duplicate_threshold=ta.get('duplicate_threshold', analysis_config.duplicate_threshold),
                    min_content_length=ta.get('min_content_length', analysis_config.min_content_length),
                    max_content_length=ta.get('max_content_length', analysis_config.max_content_length),
                    prefer_code_examples=ta.get('prefer_code_examples', analysis_config.prefer_code_examples),
                    prioritize_recent=ta.get('prioritize_recent', analysis_config.prioritize_recent),
