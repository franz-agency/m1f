...
class M1FInit:
    ...
    def _determine_project_type(self, files: List[str], dirs: List[str]) -> Dict:
        ...
        if context["type"] == "Unknown":
            ...
            # Determine primary language based on file count and indicators
            if has_python_indicators or py_count > max(js_count, ts_count, php_count, java_count):
            ...
            elif has_package_json and (js_count > 0 or ts_count > 0):
