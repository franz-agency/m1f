...
python -m tools.mf1-html2md convert ./website -o ./docs
...
python -m tools.mf1-html2md analyze ./html/*.html --suggest-selectors

# Analyze with detailed structure output
python -m tools.mf1-html2md analyze ./html/*.html --show-structure --common-patterns
```
...
python -m tools.mf1-html2md analyze .scrapes/my-project/html/*.html --suggest-selectors
...
python -m tools.mf1-html2md convert .scrapes/my-project/html -o .scrapes/my-project/md \
...
```bash
python -m tools.mf1-html2md analyze <files> [options]
```
...
python -m tools.mf1-html2md convert ./website -o ./docs --verbose
```
...
python -m tools.mf1-html2md analyze ./html/*.html

# Show detailed structure of HTML files
python -m tools.mf1-html2md analyze ./html/*.html --show-structure

# Find common patterns across multiple files
python -m tools.mf1-html2md analyze ./html/*.html --common-patterns
...
python -m tools.mf1-html2md convert ./website -o ./docs -c config.yaml
```
...
```bash
# Use with CLI
python -m tools.mf1-html2md convert ./html -o ./markdown \
  --extractor ./extractors/my_extractor.py

# Use with API
from tools.mf1-html2md.api import Html2mdConverter
...
```bash
python -m tools.mf1-html2md --source-dir ./website --destination-dir ./docs \
...
1. First convert HTML files to Markdown:
   ...
   ```bash
   python -m tools.mf1-html2md convert ./html-docs -o ./markdown-docs
   ```
