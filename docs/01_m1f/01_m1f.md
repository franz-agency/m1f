...
> **Note**: For a complete reference of all available options, see the [CLI Reference](./07_cli_reference.md). For troubleshooting, see the [Troubleshooting Guide](./08_troubleshooting.md).
